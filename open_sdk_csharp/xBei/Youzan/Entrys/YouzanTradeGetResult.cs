...
namespace YZOpenSDK.xBei.Youzan.Entrys {
    public class YouzanTradeGetResult {
        ...
        public StructurizationTradeRefundInfoDetail[] RefundOrder { get; set; }

        /// <summary>
        /// 订单发货详情结构体
        /// </summary>
        [JsonProperty("delivery_order")]
        public StructurizationTradeDeliveryDetail[] DeliveryOrder { get; set; }

        /// <summary>
        /// 订单优惠详情结构体
        /// </summary>
        [JsonProperty("order_promotion")]
        public StructurizationTradePromotionInfoDetail OrderPromotion { get; set; }

        public class StructurizationTradeDeliveryExpressInfo {
        ...
        public class StructurizationTradeRefundInfoDetail {
            ...
            /// </summary>
            [JsonProperty("oids")]
            public StructurizationTradeRefundItemDetail[] Oids { get; set; }
        ...
        public class StructurizationTradeDeliveryDetail {
            ...
            public long ExpressState { get; set; }
            ...
            /// </summary>
            [JsonProperty("oids")]
            public StructurizationTradeDeliveryItemDetail[] Oids { get; set; }

            /// <summary>
            /// 物流包裹详情
            /// </summary>
            [JsonProperty("dists")]
            public StructurizationTradeDeliveryDist[] Dists { get; set; }
        ...
        public class StructurizationTradePromotionInfoDetail {
            ...
            /// </summary>
            [JsonProperty("item")]
            public StructurizationTradePromotionItemDetail[] Item { get; set; }

            /// <summary>
            /// 优惠明细结构体
            /// </summary>
            [JsonProperty("order")]
            public StructurizationTradePromotionDetail[] Order { get; set; }

            /// <summary>
            /// 商品优惠总金额
            /// </summary>
            [JsonProperty("item_discount_fee")]
            public float ItemDiscountFee { get; set; }

            /// <summary>
            /// 订单优惠总金额
            /// </summary>
            [JsonProperty("order_discount_fee")]
            public float OrderDiscountFee { get; set; }
        ...
        public class StructurizationTradePromotionItemDetail {
            ...
            public StructurizationTradePromotionDetail[] Promotions { get; set; }
        ...
        public class StructurizationTradeDeliveryDist {
            ...
            public StructurizationTradeDeliveryExpressInfo ExpressInfo { get; set; }
